function result = MultiGraphCut(costImages,delta_l,delta_u,delta_x,delta_y)
%%%%函数名:MultiGraphCut
...
tic;
result = ConstructGraph1(costVector,dims,delta_l,delta_u,delta_x,delta_y);    %%利用C++处理构图及图割程序
toc;
