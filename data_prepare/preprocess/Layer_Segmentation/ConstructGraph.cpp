...
//                         ofs<<subindex+add_length+1<<" "<<xsubindex3+add_length+1<<" "<<INF<<" "<<0<<"\n";
                     }
                     if(x-1>=0)
                     {
                        int xsubindex3=z-deltax+(x-1)*height+y*width*height;
...
//                  ofs<<xnegsubindex2+add_length+1<<" "<<xnegsubindex3+add_length+1<<" "<<INF<<" "<<INF<<"\n";
            }
         }
        if(z-deltay>=0)
        {
...
//                     ofs<<subindex+add_length+1<<" "<<ysubindex3+add_length+1<<" "<<INF<<" "<<0<<"\n";
                }
                if(y-1>=0)
                {
                    int ysubindex3=z-deltay+x*height+(y-1)*height*width;
...
//                  ofs<<ynegsubindex2+add_length+1<<" "<<ynegsubindex3+add_length+1<<" "<<INF<<" "<<INF<<"\n";
             }
        }
    }
}
